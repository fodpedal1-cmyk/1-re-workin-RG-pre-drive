...
public:
    ...
    // OUTPUT LEVEL METER
    //
    // Audio-thread safe value used ONLY by the GUI.
    // 0.0 = silence
    // 1.0 = maximum detected output
    //
    // This does NOT affect the audio signal.
    //==========================================================
...
private:
    ...
    // OUTPUT LEVEL METER
    //
    // Written from processBlock().
    // Read from the GUI timer.
    // Atomic = safe between audio thread and GUI thread.
    //==========================================================
